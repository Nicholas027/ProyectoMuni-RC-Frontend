...
const Unauthorized = () => {
  useTitle("Acceso Restringido");
  return (
    <Container className="text-center my-5">
      <h1 className="display-1 tituloError my-4">Acceso Restringido</h1>
      <p className="display-5 mensajeError my-4">No puede acceder a esta sección</p>
